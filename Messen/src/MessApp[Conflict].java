...
public class MessApp {
  ...
  private void berechneUndDruckeMittelwerteMessreihe() {
	  ...
	  for(int i= 0; i < messSammlung.length; i++)
	  {
		  ...
		  System.out.println("Durchschnitt von Messreihe "+(i+1)+": "+(messreihe/messSammlung[i].length));
	  }
  }
	  ...
	  {	  
		  ...
		  {			
			messungDurchschnitt[ii] += messSammlung[i][ii];			  
			  ...
			  {
				  System.out.println("Durchschnitt von allen "+(i+1)+". Messungen: "+(messungDurchschnitt[ii]/messSammlung[i].length));
			  }
		  }
